...
class Detail extends Component {
  ...
  handleFormSubmit = event => {
    event.preventDefault();
      API.updatePool(this.props.match.params.id,{
    ...
    return (
      <Container fluid>
        ...
        <Row>
          <Col size="md-4"></Col>
          <Col size="md-4">
          <h1> Correct Answer: {this.state.answer1} </h1>
          </Col>
          <Col size="md-4"></Col>
        </Row>
        ...
        <Row>
          <Col size="md-4"></Col>
          <Col size="md-4">
          <h1> Correct Answer: {this.state.answer2} </h1>
          </Col>
          <Col size="md-4"></Col>
        </Row>
        ...
        <Row>
          <Col size="md-4"></Col>
          <Col size="md-4">
          <h1> Correct Answer: {this.state.answer3} </h1>
          </Col>
          <Col size="md-4"></Col>
        </Row>
        ...
        <Row>
          <Col size="md-4"></Col>
          <Col size="md-4">
          <h1> Correct Answer: {this.state.answer4} </h1>
          </Col>
          <Col size="md-4"></Col>
        </Row>
        ...
        <Row>
          <Col size="md-4"></Col>
          <Col size="md-4">
          <h1> Correct Answer: {this.state.answer5} </h1>
          </Col>
          <Col size="md-4"></Col>
        </Row>
